...
<br>
The user name in the application context is: <%=application.getAttribute("applicationUserName") %>
<br>
The user name in the page context is: <%=pageContext.getAttribute("pageContextUserName") %>
</body>
</html>